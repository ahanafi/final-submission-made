...
class MovieResultSearchAdapter: RecyclerView.Adapter<MovieResultSearchAdapter.CardViewViewHolder>() {
    ...
    override fun onCreateViewHolder(
        ...
        val view = LayoutInflater.from(vGroup.context).inflate(R.layout.item_result_search, vGroup, false)
